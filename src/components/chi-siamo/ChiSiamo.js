    ...
    <div className="bg-black w-full mb-20">
      <div className="container mx-auto grid grid-cols-12 gap-4 p-2">
        <div className="col-span-12 md:col-span-6 flex flex-col justify-center">
          <h2 className="text-4xl md:text-6xl text-end mb-2 md:mb-4">
            Chi Siamo
          </h2>
          <p className="p-2 border-t border-l text-lg">
            ...
            del luogo e i visitatori di passaggio. Offriamo una vasta selezione
            di caffè di alta qualità, cocktail artigianali e sfiziosi
            stuzzichini per accompagnare le vostre chiacchiere.
          </p>
        </div>
